...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     <li>Captain:- Steve Smith(All Formats)</li>
     <li>Head Coach:- Darren Lehmann </li>
     <li>Batting Coach:- Greame Hick</li>
     <li>Bowling Coach:- John Davison</li>
     <li>Fielding coach:- Brad Haddin</li>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=1" style="width: 180px;">Allan Border</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('aus.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=2" style="width: 180px;">Steve Smith</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=3" style="width: 180px;">Adam Gilchrist</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=4" style="width: 180px;">Greg Chappell</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=5" style="width: 180px;">Shane Warne</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=6" style="width: 180px;">Brett Lee</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="aus.php?id=9" style="width: 280px;">T20</a>
