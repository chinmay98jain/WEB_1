...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     ...
     <li>Head Coach:- Ottis Gibson</li>
     <li>Batting Coach:- Dale benkenstein</li>
     <li>Bowling Coach:- Claude Henderson</li>
     <li>Fielding coach:- Justin Ontong</li>
     <li>Team Manager:- Lerato Malekutu</li>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=1" style="width: 180px;">Greame Smith</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('sa.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=2" style="width: 180px;">Ab de Villers</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=3" style="width: 180px;">Hashim Amla</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=4" style="width: 180px;">Jacques Kallis</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=5" style="width: 180px;">Shaun Pollock</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=6" style="width: 180px;">Dale Styen</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="sa.php?id=9" style="width: 280px;">T20</a>
