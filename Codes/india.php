...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     <li>Captain:- Virat Kohli(All Formats)</li>
     <li>Head Coach:- Ravi Shastri </li>
     <li>Batting Coach:- Sanjay Bangar</li>
     <li>Bowling Coach:- Bharat Arun</li>
     <li>Fielding coach:- Ramakrishnan Sridhar</li>
     <li>Team Manager:- Suniel Subramanium</li>
   </ul>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=1" style="width: 180px;">Sachin Tendulkar</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('india.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=2" style="width: 180px;">Virat Kohli</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=3" style="width: 180px;">M.S.Dhoni</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=4" style="width: 180px;">Kapil Dev </a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=5" style="width: 180px;">Anil Kumble</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=6" style="width: 180px;">Zaheer Khan</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="india.php?id=9" style="width: 280px;">T20</a>
