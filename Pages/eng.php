...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     <li>Captain:- Joe Root(Test),Eoin Morgan(ODI,T20)</li>
     <li>Head Coach:- Trevor Bayliss</li>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=1" style="width: 180px;">Graham Goach</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('eng.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=2" style="width: 180px;">Joe Root</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=3" style="width: 180px;">Kevin Pietersen</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=4" style="width: 180px;">Sir Ian Botham</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=5" style="width: 180px;">Greame Swann</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=6" style="width: 180px;">James Anderson</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="eng.php?id=9" style="width: 280px;">T20</a>
