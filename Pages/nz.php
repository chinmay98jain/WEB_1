...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     ...
     <li>Head Coach:- Mike Hesson</li>
     <li>Batting Coach:- Craig McMilan</li>
     <li>Bowling Coach:- Shane Jurgensen</li>
     <li>Fielding coach:- Chris Donaldson</li>
     <li>Team Manager:- Mike Sandle</li>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=1" style="width: 180px;">Sir Richard Hadlee</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('nz.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=2" style="width: 180px;">Kane Williamson</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=3" style="width: 180px;">Brendon McCullum</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=4" style="width: 180px;">Chris Harris</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=5" style="width: 180px;">Shane Bond</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=6" style="width: 180px;">Trent Boult</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="nz.php?id=9" style="width: 280px;">T20</a>
