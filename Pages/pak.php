...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     <li>Captain:- Sarfarz Ahmed</li>
     <li>Head Coach:- Mickey Arthur</li>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=1" style="width: 180px;">Inzamam-ul-haq</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('pak.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=2" style="width: 180px;">Babar Azam</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=3" style="width: 180px;">Shoaib Malik</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=4" style="width: 180px;">Shahid Afridi</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=5" style="width: 180px;">Wasim Akram</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=6" style="width: 180px;">Shoaib Akhtar</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="pak.php?id=9" style="width: 280px;">T20</a>
