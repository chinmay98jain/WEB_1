...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     <li>Captain:- Dinesh Chandimal(Test),Angelo Mathews(ODI,T20)</li>
     <li>Head Coach:- Chandika Hathurusinghe</li>
     <li>Batting Coach:- Thilan Samaraweera</li>
     <li>Bowling Coach:- Rumesh Ratnayake</li>
     <li>Fielding coach:- Nick Lee</li>
     <li>Team Manager:- Asanka Gurusinha</li>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=1" style="width: 180px;">Arvinda de Silva</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('sr.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=2" style="width: 180px;">Sanath Jayasuriya</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=3" style="width: 180px;">Kumar Sangakarra</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('sr.xml');
          ...
          echo $xml->records[2]->dob.'<br/>'.$xml->records[2]->test.'<br/>'.$xml->records[2]->runs.'<br/>'.$xml->records[2]->avg.'<br/>'.$xml->records[2]->ms.'<br/>'.$xml->records[2]->hs.'<br/>'.$xml->records[2]->wks.'<br/>'.$xml->records[2]->odi.'<br/>'.$xml->records[2]->oruns.'<br/>'.$xml->records[2]->oavg.'<br/>'.$xml->records[2]->oms.'<br/>'.$xml->records[2]->ohs.'<br/>'.$xml->records[2]->owks.'<br/>'.$xml->records[2]->t20.'<br/>'.$xml->records[2]->truns.'<br/>'.$xml->records[2]->tavg.'<br/>'.$xml->records[2]->tms.'<br/>'.$xml->records[2]->ths.'<br/>'.$xml->records[2]->twks.'<br/>';
 }       
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=4" style="width: 180px;">Tillakratne Dilshan</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=5" style="width: 180px;">Muttiah Murlidharan</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=6" style="width: 180px;">Lasith Malinga</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="sr.php?id=9" style="width: 280px;">T20</a>
