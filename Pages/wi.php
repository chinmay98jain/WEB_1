...
<div id="team">
  <div class="container-fluid text-center"><br/><br/>
   ...
   <ul class="team" style="font-size: 25px;">
     <li>Captain:- Jason Mohammad(T20),Jason Holder(ODI,Test)</li>
     <li>Head Coach:- Stuart Law</li>
     <li>Batting Coach:- Toby Radford</li>
     <li>Bowling Coach:- Alfonso Thomas</li>
     <li>Fielding coach:- Ryan Maron</li>
     <li>Team Manager:- Rawl Lewis</li>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=1" style="width: 180px;">Brian Lara</a>
...
{        $val=$_GET['id'];
         $xml= simplexml_load_file('wi.xml');
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=2" style="width: 180px;">Chris Gayle</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=3" style="width: 180px;">Sir Viv Richards</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=4" style="width: 199px;">Shivnaraine Chanderpaul</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=5" style="width: 180px;">Jerome Taylor</a>
...
{        $val=$_GET['id'];
     ...
     <div class="col-md-2 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=6" style="width: 180px;">Dwayne Bravo</a>
...
<div id="team">
  <div class="container-fluid text-center"><br/><br/><hr/>
   ...
   <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=7" style="width: 280px;">Test</a>
...
<div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=8" style="width: 280px;">ODI</a>
...
{        $val=$_GET['id'];
    ...
    <div class="col-md-4 col-12">
        <a class="nav-link btn btn-primary" href="wi.php?id=9" style="width: 280px;">T20</a>
